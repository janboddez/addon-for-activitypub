...
namespace AddonForActivityPub\Mf2;
...
class Parser
{
    ...
    public function __construct($input, $url = null, $jsonMode = \false)
    {
        ...
        if (\is_string($input)) {
            if (\class_exists('AddonForActivityPub\\Masterminds\\HTML5')) {
                $doc = new \AddonForActivityPub\Masterminds\HTML5(array('disable_html_ns' => \true));
